...
- 5dd8b2b: Calendar: fix the quick-nav caption not opening on a real mouse click. The
...
- c5b1b16: Release 0.2.1 — Toggle, Sidebar rewrite, DataTable upgrades, form polish.
