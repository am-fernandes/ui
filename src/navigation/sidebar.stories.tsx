    ...
    docs: {
      description: {
        component: [
          ...
          "  defaultOpen?: boolean               // estado inicial do submenu (default false)",
...
export const WithSubmenu: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: [
          "Itens com `items` (filhos) renderizam como **trigger colapsável** — uma seta gira indicando o estado, e `aria-expanded` é setado pra a11y.",
          "",
          "Por padrão **todo submenu nasce fechado**. Passe `defaultOpen: true` no item para iniciar aberto. No exemplo, `Relatórios` abre por padrão; `Usuários` fica fechado até o clique.",
          "",
          "```tsx",
          "<Sidebar",
          "  items={[",
          ...
          '      label: "Usuários",',
          "      icon: Users,",
          "      // sem defaultOpen → submenu nasce fechado",
          "      items: [",
          '        { id: "list", label: "Lista", href: "/users" },',
          "      ],",
          "    },",
          ...
          "```",
          "",
          "Quando um item tem filhos, o `href` do próprio item é ignorado (clique sempre toggla o submenu). Para um link navegável, use um filho.",
        ].join("\n"),
      },
    },
  },
