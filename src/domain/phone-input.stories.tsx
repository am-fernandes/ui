    ...
    docs: {
      description: {
        component: [
          ...
          "",
          "**Validação:** o componente é apenas um formatador. Para validar use `isValidPhone` de `@amfernandesinc/ui/lib/brazil`.",
          "",
          "**Exemplo de uso:**",
          "",
          "```tsx",
          'import { PhoneInput, isValidPhone } from "@amfernandesinc/ui"',
          "",
