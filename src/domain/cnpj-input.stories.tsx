    ...
    docs: {
      description: {
        component: [
          ...
          "",
          "**Validação:** o componente é apenas um formatador. Para validar o DV use `isValidCNPJ` de `@amfernandesinc/ui/lib/brazil`.",
          "",
          "**Exemplo de uso:**",
          "",
          "```tsx",
          'import { CNPJInput, isValidCNPJ } from "@amfernandesinc/ui"',
          "",
