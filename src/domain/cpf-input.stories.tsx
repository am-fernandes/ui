    ...
    docs: {
      description: {
        component: [
          ...
          "",
          "**Validação:** o componente é apenas um formatador. Para validar o DV use `isValidCPF` de `@am-fernandes/ui/lib/brazil`.",
          "",
          "**Exemplo de uso:**",
          "",
          "```tsx",
          'import { CPFInput, isValidCPF } from "@am-fernandes/ui"',
          "",
