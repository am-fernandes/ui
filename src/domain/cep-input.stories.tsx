    ...
    docs: {
      description: {
        component: [
          ...
          "",
          "**Validação:** o componente é apenas um formatador. Para validar o tamanho use `isValidCEP` de `@am-fernandes/ui/lib/brazil`.",
          "",
          "**Exemplo de uso:**",
          "",
          "```tsx",
          'import { CEPInput, isValidCEP } from "@am-fernandes/ui"',
          "",
