    ...
    docs: {
      description: {
        story: [
          ...
          "",
          "Use o helper `formatCount(count, max?)` (exportado da lib) para limitar o número exibido — default cap em **9999+**. Acima do max vira `${max}+`; valores negativos/non-finite são clamped para `0`.",
          "",
          "```tsx",
